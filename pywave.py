...
HTailAOA = flightAOA + HtailIncidence - DownwashAngle + ElevatorEffectivenessTau * ElevatorDeflection
...
WingPitchMoment = wing_pitching_moment(q_dyn, WingArea, Cl, Xwqc, Xcg)
HTailPitchMoment = htail_pitching_moment(q_dyn, WingArea, ClHtail, Xhtqc, Xcg)
WingAirfoilMoment = q_dyn * WingArea * MAC * Cm_wing
WingTotalPitchMoment = WingPitchMoment + WingAirfoilMoment
HTailAirfoilMoment = q_dyn * HTailArea * HMAC * Cm_htail
